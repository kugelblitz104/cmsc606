...
def read_csv_convert_to_numpy(fileName='carSUV_normalized.csv'):
    ...
    numpy_x = np.zeros((10,2)) # placeholder code to make the file compile; you should remove it
    numpy_y = np.zeros((10,1)) # placeholder code to make the file compile; you should remove it
    # YOUR CODE HERE
...
def calc_error_rate_for_single_vector_w(w, numpy_x, numpy_y):
    ...
    error_rate = 0.5 #placeholder value of 50% error to make code compile; you should remove it
    # YOUR CODE HERE
...
def train_and_evaluate(numpy_x, numpy_y, n_epochs = 20, c = 0.01):
    ...
    w = np.zeros((2,1)) #placeholder value of all-zeros weights to make code compile; you should remove it
    # YOUR CODE HERE
